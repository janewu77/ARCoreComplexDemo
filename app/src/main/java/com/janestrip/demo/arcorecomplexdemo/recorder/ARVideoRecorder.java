 ...
 */
public class ARVideoRecorder {
  private static final String TAG = "ARVideoRecorder";
  private static final int DEFAULT_BITRATE = 10000000;
  private static final int DEFAULT_FRAMERATE = 30;

  private static final String DEFAULT_BASENAME = "Sample";
  private static final String DEFAULT_DIR = "/Sceneform";
  ...
  private void buildFilename() {
    ...
    if (videoBaseName == null || videoBaseName.isEmpty()) {
      videoBaseName = DEFAULT_BASENAME;
    }
    videoPath =
        new File(
