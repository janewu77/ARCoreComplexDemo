 ...
 */
public class PlanetNode extends Node implements Node.OnTapListener {
...
//  private Node planetVisual;
  ...
  public void onActivate() {
    ...
    if (planetVisual == null) {
      ...
      //抵消公转带来的转向变动。使得在空间中公转时，仍然保持自身的方向不变。（以便后面，进行自转的计算）
      RotatingNode counterOrbit = new RotatingNode(solarSettings, true, true, 0);
